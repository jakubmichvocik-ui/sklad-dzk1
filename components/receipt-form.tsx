...
export default function ReceiptForm({
  ...
  return (
    <form action="/movements/receive" method="post" className="space-y-4">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
        <div className="mb-3 text-sm font-semibold text-gray-900">2. Kam naskladniť</div>
      ...
      <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4 shadow-sm">
        <div className="text-sm text-blue-700">Aktuálny stav na lokácii</div>
