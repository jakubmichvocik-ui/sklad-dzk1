...
export default async function InventoryDetailPage({
  ...
  return (
    <div className="space-y-6 pb-24 md:pb-6">
      ...
      <SectionCard
        title="Informácie o inventúre"
        description="Základné údaje o inventúrnej session"
      >
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-gray-200 p-4">
            <div className="text-sm text-gray-500">Sklad</div>
          ...
          <div className="rounded-xl border border-gray-200 p-4">
            ...
            <div className="mt-1 font-medium text-gray-900">{session.status}</div>
          </div>
      ...
      <SectionCard
        ...
        description="Mobilné karty pre pohodlné sčítanie"
      >
        {error ? (
          <div className="rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
